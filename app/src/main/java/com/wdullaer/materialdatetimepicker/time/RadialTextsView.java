...
public class RadialTextsView extends View {
    ...
    public void initialize(Context context, String[] texts, String[] innerTexts,
        ...
        mPaint.setColor(getResources().getColor(textColorRes));
        ...
        int selectedTextColor = getResources().getColor( R.color.mdtp_white);
        ...
        mInactivePaint.setColor(getResources().getColor(inactiveColorRes));
