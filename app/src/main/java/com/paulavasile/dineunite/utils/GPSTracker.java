...
public final class GPSTracker implements LocationListener {
	...
	public void showSettingsAlert() {
		 ...
		 * // true if (gpsdialog == true) { Dialog dialog2 = createDialog();
		 * dialog2.show(); }
		 */
	...
	public Dialog createDialog() {
		 ...
		 * 
		 * neverShow.setVisibility(View.GONE);
		 */
		...
		/*
		 * .setNegativeButton(R.string.location_skip, new
		 * DialogInterface.OnClickListener() { public void
		 * onClick(DialogInterface dialog, int id) { // User cancelled the
		 * dialog if (checkbox.isChecked()) { doNotShowAgain(); } } })
		 */;
