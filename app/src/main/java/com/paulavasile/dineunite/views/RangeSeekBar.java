...
import com.paulavasile.dineunite.utils.PixelUtil;
...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    /**
     * Default color of a {@link RangeSeekBar}, #FFF78515. This is also known as "Ice Cream Sandwich" blue.
     */
    public static final int DEFAULT_COLOR = Color.argb(0xFF, 0xF7, 0x85, 0x15);
    /**
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs == null) {
            ...
            surffix = (String) a.getText(R.styleable.RangeSeekBar_surffix);
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        String minLabel = "";//String.valueOf(absoluteMinValue);
        String maxLabel = "";//String.valueOf(absoluteMaxValue);
